...
class CafeForm(FlaskForm):
    ...
    c_time = StringField('Closing Time e.g 8PM', validators=[DataRequired()])
    rating = SelectField('Coffee rating', validators=[DataRequired()], choices=["☕️", "☕️☕️", "☕️☕️☕️", "☕️☕️☕️☕️", "☕️☕️☕️☕️☕️"])
...
def add_cafe():
    ...
    if form.validate_on_submit() and request.method=="POST":
        print("True")
        text = f"\n{form.cafe.data},{form.location.data},{form.o_time.data},{form.c_time.data},{form.rating.data},{form.wifi_strength.data}"
